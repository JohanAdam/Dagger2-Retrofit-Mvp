...
public class DialogRatingCs implements OnClickListener {
  ...
  private DialogRatingCsCallback listener;

  public DialogRatingCs() {
  }
  ...
  public void showDialog(Context context, DialogRatingCsCallback listener) {
  ...
  public void onClick(View v) {
    if  (dialog.isShowing()) {
        if (listener != null) {
          listener.onClick(seekbar.getProgress() + 1, etFeedback.getText().toString());
        }
        removeDialog();
    }
  }

  public interface DialogRatingCsCallback {
    void onClick(int rating, String feedback);
  }
}
