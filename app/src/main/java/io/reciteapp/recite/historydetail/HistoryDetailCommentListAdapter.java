...
class HistoryDetailCommentListAdapter extends RecyclerView.Adapter<HistoryDetailCommentListAdapter.ViewHolder> {

  private final MainActivity mContext;
  private List<ReviewerCommentResponse> commentLists;
  private String userAudioUri;

  HistoryDetailCommentListAdapter(MainActivity activity, List<ReviewerCommentResponse> responses,
      String userAudioUri) {
  ...
  private void openComment(ReviewerCommentResponse data) {
